...
#biomarkers 
biomarker_data = pd.read_csv('/home/theomathema/AWI-Gen/phase2/biomarkers/AWIGen2BiomarkerResu-AWIGen2Biomarkers_DATA_2023-11-29_1355.csv', sep=';')

#upload the agincourt data 
...
#upload all microbiome participants
micro_participants = pd.read_csv(file_path + 'microbiome_study_ids_27_07_23.csv', sep = ';')

#upload agincourt participants with missing phenotype data
...
#merge phase 2 data with biomarker data
...
#add the missing phenotype variables
...
#print(micro_participants.shape)
#print(micro_data_2.shape)
...
#print(micro_data_complete.shape)
...
print(microbiome_phenotype_data[microbiome_phenotype_data['study_id'].isin(agincourt_missing_study_ids_microbiome_phenotype['study_id'])][['micr_take_antibiotics',
                                                    'micr_diarrhea_last_time', 'micr_worm_intestine_treat', 'micr_probiotics_t_period',
                                                    'micr_wormintestine_period', 'micr_probiotics_taken']])
