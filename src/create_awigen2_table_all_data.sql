...
gene_site integer,
gene_enrolment_date text,
gene_start_time text,
...
preg_menopause_status_c integer GENERATED ALWAYS AS (
  CASE
...
bloc_urine_taken_date text,
bloc_urinecollection_time text,
...
gene_end_time text,
subs_smoke_cigarettes___6 integer,
